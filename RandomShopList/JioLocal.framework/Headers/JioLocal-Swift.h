...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="JioLocal",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8JioLocal15DelegateManager")
...
SWIFT_CLASS("_TtC8JioLocal21KMPlaceholderTextView")
...
@property (nonatomic, copy) NSString * _Nonnull errorViewMsg;
